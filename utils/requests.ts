...
const requests = {
  fetchTrend: `${BASE_URL}/trending/all/week?api_key=${API_KEY}&language=fr-FR`,
  fetchDiscover: `${BASE_URL}/discover/movie?api_key=${API_KEY}&language=fr-FR&with_networks=213`,
